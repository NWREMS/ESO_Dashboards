...
First, download the dashboard of interest to your local computer.  Then do the following:
<ol>
<li>Browse to https://sisense.esosuite.net/app/main/home
<li>Log in usng your usual ESO credentials
<li>In the left sidebar, next to the word "Dashboards", click on the "+" sign.
<li>Select "Import Dashboards"
<li>A file picker dialog will open.  Navigate to the dashboard file on your local computer, and click "Open".
<li>The dashboard will appear in the list in the left sidebar.
</ol>
...
| NWREMS_ChestPainSTEMISceneTime.dash | Shows the average on-scene time for calls involving chest pain or STEMI. |
...
| NWREMS_StrokeTIASceneTime.dash | Shows the average on-scene time in total and by person, for calls involving stroke/TIA. |
